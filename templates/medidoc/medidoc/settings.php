<?php include('header.php'); ?>
    ...
    <div class="app-main__inner">
                ...
                <div class="page-title-heading">
                    <div class="card-body p-0">
                        <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                            <li class="nav-item">
                                <h5 style="margin-top:16px;font-size: 18px;font-weight: 700;padding-bottom: 10px;">Settings Page</h5>
                            </li>
                        </ul>
                    </div>
                </div>   
        ...
        <div class="container-fluid pl-0 pr-0 min-h-100">
            <div class="row gutters-sm">
                <div class="col-md-4 d-none d-md-block">
                    <div class="card">
                        <div class="card-body">
                            <nav class="nav flex-column nav-pills nav-color nav-gap-y-1">
