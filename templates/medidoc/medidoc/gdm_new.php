<?php include('header.php'); ?>
    ...
    <div class="app-main__inner">
        ...
        <div class="app-page-title pt-0 pb-0">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div class="card-body p-0">
                        <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                            ...
                            <li class="nav-item">
                                <a role="tab" class="nav-link font-small-14 bold" id="tab-1" data-toggle="tab" href="#gdm">
                                    <span>GDM Diagnosis</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="page-title-actions pt-20">
                    ...
                    <div class="d-inline-block">
                        <a href="./new_encounter.php" class="mb-2 mr-2 btn btn-primary">
                            <span class="btn-icon-wrapper pr-2 opacity-7">
        ...
        <div class="tab-content pt-20">
            ...
            <div class="tab-pane tabs-animation fade show active" id="patient-overview" role="tabpanel">
                <div class="row">
                    <div class="col-md-8 pr-0">
                        <div class="row">
                                ...
                                <div class="main-card mb-3 card min-h-300">
                                    <div class="card-body text-center pb-16">
                                        ...
                                        <div class="card-body pb-0 pl-0 pr-0">
                                            ...
                                            <p class="text-mute mt-10 mb-0">+977 9818344862</p>
                                            <p class="text-mute">celeste@gmail.com</p>
                                            <table class="mb-0 table table-borderless">
                                                <tbody>
                                                    <tr>
                                                        <td width="50%" class="text-center" style="border-right: 2px solid #E5E8E8;">
                                                            <h5 class="bold">12</h5>
                                                            <p class="text-mute font-small text-center mt--10 mb-0">Past</p>
                                                        </td>
                                                        <td width="50%" class="text-center">
                                                            <h5 class="bold">2</h5>
                                                            <p class="text-mute font-small text-center mt--10 mb-0">Upcoming</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <div class="col-md-8 pl-0">
                                <div class="main-card mb-3 card min-h-300">
                                    <div class="card-body">
                                        <div class="card-header h-0 pl-0 mb-10">
                                            <h6 class="card-title mb-0">Profile</h6>
                                            <a class="ml-auto" href="#">
                                                <i class="fas fa-edit right" aria-hidden="true"></i>
                                            </a>
                                        </div>
                                        <table class="mb-0 table table-borderless">
                                            <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="bold">ID/License</p>
                                                    <p class="text-mute font-12 mt--10">060-3120911</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <div class="card-body">
                                        <ul class="tabs-animated-shadow tabs-animated nav">
                                            ...
                                            <li class="ml-auto nav-item">
                                                <a class="nav-link show appointment-link" href="#">
                                                                    ...
                                                                    <div class="widget-content-wrapper">
                                                                        <div class="row" style="width: 100%;">
                                                                            <div class="col-md-2 text-center">
                                                                                <img width="50" class="rounded-circle" src="./assets/images/avatars/1.png" alt="">
                                                                            </div>
                                                            ...
                                                            <div class="list-group-item">
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        <div class="row" style="width: 100%;">
                                                                            <div class="col-md-2 text-center">
                                                                                <img width="50" class="rounded-circle" src="assets/images/avatars/2.png" alt="">
                                                                            </div>
                                                                            <div class="col-md-5 pl-0 pt-05">
                                                                                <div class="widget-heading bold">Dr. Ella-Rose Henry</div>
                                                                                <div class="widget-subheading text-mute">Surgery</div>
                                                            ...
                                                            <div class="list-group-item">
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        <div class="row" style="width: 100%;">
                                                                            <div class="col-md-2 text-center">
                                                                                <img width="50" class="rounded-circle" src="assets/images/avatars/3.png" alt="">
                                                                            </div>
                                                                            <div class="col-md-5 pl-0 pt-05">
                                                                                <div class="widget-heading bold">Dr. Ella-Rose Henry</div>
                                                                                <div class="widget-subheading text-mute">Surgery</div>
                                                            ...
                                                            <div class="list-group-item">
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        <div class="row" style="width: 100%;">
                                                                            <div class="col-md-2 text-center">
                                                                                <img width="50" class="rounded-circle" src="assets/images/avatars/4.png" alt="">
                                                                            </div>
                                                                            <div class="col-md-5 pl-0 pt-05">
                                                                                <div class="widget-heading bold">Dr. Ella-Rose Henry</div>
                                                                                <div class="widget-subheading text-mute">Surgery</div>
                                                            ...
                                                            <div class="list-group-item">
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        <div class="row" style="width: 100%;">
                                                                            <div class="col-md-2 text-center">
                                                                                <img width="50" class="rounded-circle" src="assets/images/avatars/5.png" alt="">
                                                                            </div>
                                                                            <div class="col-md-5 pl-0 pt-05">
                                                                                <div class="widget-heading bold">Dr. Ella-Rose Henry</div>
                                                                                <div class="widget-subheading text-mute">Surgery</div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3">
                            <div class="card-body">
                                <div class="card-header h-0 pl-0 mb-10 pr-0">
                                ...
                                <ul class="rm-list-borders rm-list-borders-scroll list-group list-group-flush family-list">
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    ...
                                                    <div class="widget-subheading">Friend</div>
                                                </div>
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    ...
                                                    <div class="widget-subheading">Husband</div>
                                                </div>
                                                <div class="widget-content-right-force">
                                                    <a href="">
                                                        <i class="fas fa-ellipsis-h right"></i>
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    ...
                                                    <div class="widget-subheading">Mother</div>
                                                </div>
                                                <div class="widget-content-right-force">
                                                    <a href="">
                                                        <i class="fas fa-ellipsis-h right"></i>
                                    ...
                                    <li class="list-group-item">
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    <div class="widget-heading">Ella-Rose Henry</div>
                                                    <div class="widget-subheading">Sister</div>
                                                </div>
                                                <div class="widget-content-right-force">
                                                    <a href="">
                                                        <i class="fas fa-ellipsis-h right"></i>
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <div class="card-header h-0 pl-0 mb-10 pr-0">
                                    <h6 class="card-title mb-0">Medical Information</h6>
                                    <a class="ml-auto" href="#">
                                        <i class="fas fa-edit right" aria-hidden="true"></i>
                                    </a>
                                </div>
            ...
            <div class="tab-pane tabs-animation fade" id="prescription" role="tabpanel">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card-header h-0 pl-0 mb-0">
                        ...
                        <hr class="mt-9">
                        <div class="main-card mb-3 card">
                            <div class="card-body pt-15 pb-10">
                                <div class="row mr--25 ml--30">
                                    <div class="col-md-2 text-center">
                                        <i class="fas fa-file-alt font-18 color-default"></i>
                                    </div>
                                    <div class="prescription-name col-md-8 ml--12 pl-0">
                                        <h6>Propanol 20mg Tab</h6>
                                    </div>
                                    <div class="col-md-2 text-right pr-0 mt-4">
                                        <button type="button" data-toggle="collapse" href="#collapse-active1" class="btn mt--10" aria-expanded="true">
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body pt-15 pb-10">
                                <div class="row mr--25 ml--30">
                                    ...
                                    <div class="col-md-2 text-right pr-0 mt-4">
                                        <button type="button" data-toggle="collapse" href="#collapse-active2" class="btn collapsed mt--10" aria-expanded="false">
                                            <i class="fas fa-chevron-down"></i>
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="tab-pane tabs-animation fade" id="gdm" role="tabpanel">
                <div class="row">
                    <div class="graph col-7">
                        <div class="row p-0">
                                ...
                                <div class="card card-chart mb-2">
                                    <div class="card-header">
                                        ...
                                        <div class="btn-actions-pane-right">
                                            <a href="" class="btn btn-light">View Data</a>
                                        </div>
                                    </div>
                                    <div class="card-body mb-0 pb-0 mt--30">
                                        <figure class="highcharts-figure pt-10 ml--10">
                    ...
                    <div class="table-data col-5">
                        <div class="main-card mb-3 card">
                            <div class="card-header">
                                Blood Glucose Level
                                <div class="btn-actions-pane-right">
                                    <a data-toggle="modal" data-target="#modal_aside_right" href="" class="btn btn-primary">Add New Data</a>
                                </div>
                            </div>
                            <div class="card-body mt--10">
                                <div class="table-responsive">
                                    <table id="blood-glucose-table" class="table table-hover table-striped table-bordered dataTable dtr-inline" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Date</th>
                                                <th>Fasting</th>
    ...
    <script type="text/javascript">
        ...
        Highcharts.chart('weightChart', {
            ...
            colors: ['#5DADE2', '#F0B27A', '#D2B4DE'],
            exporting: { enabled: false },
            series: [{
                name: 'Gained Weight',
                data: [45,46,48,52,56,57,60]
            }, {
                name: 'Initial Weight',
